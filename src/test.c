...
int main(int argc __attribute__((unused)), char **argv __attribute__((unused))) {
    ...
    smaths_parameter_set(&sine.freq, smaths_graph_normalized_frequency(&bridge.graph, SMATHS_C));
    sleep(1);
    smaths_parameter_set(&sine.freq, 0.0f);
    OK();
    ...
    r = smaths_parameter_connect(&sine.freq, &inst.out);
    CHECK_R();
    OK();
    ...
    smaths_inst_play(&inst, smaths_graph_normalized_frequency(&bridge.graph, 2.0f * SMATHS_C));
    sleep(1);
    OK();
    ...
    CHECK_R();
    r = smaths_parameter_connect(&key.note, &inst.out);
    CHECK_R();
    ...
    CHECK_R();
    r = gln_socket_connect(&envg2.ctl, &inst2.ctl);
    CHECK_R();
    r = smaths_parameter_connect(&key2.note, &inst2.out);
    CHECK_R();
    ...
    CHECK_R();
    r = smaths_parameter_connect(&mix_in1, &distort.out);
    CHECK_R();
    r = smaths_parameter_connect(&distort.in, &sine.out);
    CHECK_R();
    ...
    r = smaths_parameter_connect(&mix_in1, &saw.out);
    CHECK_R();
    r = smaths_parameter_connect(&saw.amp, &envg.out);
    CHECK_R();
    r = smaths_parameter_connect(&saw.freq, &key.freq);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    r = smaths_parameter_connect(&mix_in1, &bola.out);
    CHECK_R();
    r = smaths_parameter_connect(&bola.amp, &envg.out);
    CHECK_R();
    r = smaths_parameter_connect(&bola.freq, &key.freq);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    r = smaths_parameter_connect(&mix_in1, &itrain.out);
    CHECK_R();
    r = smaths_parameter_connect(&itrain.amp, &envg.out);
    CHECK_R();
    r = smaths_parameter_connect(&itrain.freq, &key.freq);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    r = smaths_parameter_connect(&mix_in1, &integrator.out);
    CHECK_R();
    smaths_parameter_set(&mix_in1_amp, 0.25f);
    r = smaths_parameter_connect(&integrator.in, &itrain.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    r = smaths_parameter_connect(&integrator.in, &intgr2.out);
    CHECK_R();
    r = smaths_parameter_connect(&intgr2.in, &itrain.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    CHECK_R();
    smaths_parameter_set(&porta.lag, smaths_graph_normalized_time(&bridge.graph, 1.0f));
    smaths_parameter_set(&mix_in1_amp, 0.5f);
    r = smaths_parameter_connect(&mix_in1, &itrain.out);
    CHECK_R();
    r = smaths_parameter_connect(&porta.in, &inst.out);
    CHECK_R();
    r = smaths_parameter_connect(&key.note, &porta.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 2.0f);
    ...
    r = smaths_parameter_connect(&key.note, &inst.out);
    CHECK_R();
    r = smaths_parameter_connect(&lowpass.freq, &porta.out);
    CHECK_R();
    r = smaths_parameter_connect(&mix_in1, &lowpass.out);
    CHECK_R();
    r = smaths_parameter_connect(&lowpass.in, &itrain.out);
    CHECK_R();
    smaths_parameter_set(&porta.in, 0.0f);
    sleep(1);
    smaths_inst_play(&inst, 0.0f);
    ...
    CHECK_R();
    r = smaths_parameter_connect(&bandpass.freq, &porta.out);
    CHECK_R();
    r = smaths_parameter_connect(&mix_in1, &bandpass.out);
    CHECK_R();
    r = smaths_parameter_connect(&bandpass.in, &itrain.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    smaths_parameter_set(&porta.in, 0.5f);
    sleep(1);
    ...
    CHECK_R();
    r = smaths_parameter_connect(&highpass.freq, &porta.out);
    CHECK_R();
    r = smaths_parameter_connect(&mix_in1, &highpass.out);
    CHECK_R();
    r = smaths_parameter_connect(&highpass.in, &itrain.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    smaths_parameter_set(&porta.in, 0.5f);
    sleep(1);
    ...
    CHECK_R();
    r = smaths_parameter_connect(&notch.freq, &porta.out);
    CHECK_R();
    r = smaths_parameter_connect(&mix_in1, &notch.out);
    CHECK_R();
    r = smaths_parameter_connect(&notch.in, &itrain.out);
    CHECK_R();
    smaths_inst_play(&inst, 0.0f);
    smaths_parameter_set(&porta.in, 0.5f);
    sleep(1);
    ...
    // smaths_parameter_set(&mix_in1_amp, 0.25f);
    r = smaths_parameter_connect(&mix_in1, &square.out);
    CHECK_R();
    r = smaths_parameter_connect(&square.amp, &envg.out);
    CHECK_R();
    r = smaths_parameter_connect(&square.freq, &key.freq);
    CHECK_R();
    r = smaths_parameter_connect(&square.skew, &porta.out);
    CHECK_R();
    ...
    smaths_inst_play(&inst, 0.0f);
    sleep(1);
    smaths_parameter_set(&porta.in, 1.0f);
    sleep(1);
    smaths_inst_stop(&inst);
    sleep(1);
    smaths_parameter_set(&porta.lag, 0.0f);
    ...
    // smaths_parameter_set(&mix_in1_amp, 0.4f);
    r = smaths_parameter_connect(&mix_in1, &triangle.out);
    CHECK_R();
    r = smaths_parameter_connect(&triangle.amp, &envg.out);
    CHECK_R();
    r = smaths_parameter_connect(&triangle.freq, &key.freq);
    CHECK_R();
    r = smaths_parameter_connect(&triangle.skew, &porta.out);
    CHECK_R();
    smaths_parameter_set(&porta.lag, 0.0f);
    smaths_parameter_set(&porta.in, 0.5f);
    smaths_parameter_set(&porta.lag, smaths_graph_normalized_time(&bridge.graph, 1.0f));
